...
\begin{equation}|x_i - x|\end{equation}

\begin{equation}\sum_{i=1}^n |x_i - x|\end{equation}

\begin{equation}\displaystyle\sum_{i=1}^n |x_i - x|\end{equation}

\begin{equation}\underset{\rm x}{\rm arg min}} \displaystyle\sum_{i=1}^n |x_i - x|\end{equation}

\begin{equation}\mathbf{w}_{t+1} = \underset{\mathbf{w}}{\operatorname{argmin}} \displaystyle\sum_{s=1}^t \mathbf{g}\cdot\mathbf{w}\end{equation}
