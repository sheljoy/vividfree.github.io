...
\begin{equation}\mathbf{w}_{t+1} = \underset{\rm \mathbf{w}}{\rmi arg\ min}(\displaystyle\sum_{s=1}^t \mathbf{g}_s \cdot \mathbf{w})\end{equation}

\begin{equation}\mathbf{w}_{t+1} = \underset{\rm \mathbf{w}}{\rmi arg\ min}(\displaystyle\sum_{s=1}^t \mathbf{g}_s \cdot \mathbf{w} + \frac 12 \displaystyle\sum_{s=1}^t \sigma_s\|\|\mathbf{w} - \mathbf{w}_s\|\|_2^2 + \lambda_1\|\|\mathbf{w}\|\|_1)\end{equation}
