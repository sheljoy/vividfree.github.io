...
\begin{equation}c \cdot d\end{equation}

\begin{equation}\mathbf{g}_s \cdot \mathbf{w}\end{equation}

\begin{equation}\mathbf{g}_s \cdot \mathbf{w} + \frac 12 \sigma_s\|\|\mathbf{w} - \mathbf{w}_s\|\|_2^2\end{equation}
...
\begin{equation}\mathbf{w}_{t+1} = \underset{\rm \mathbf{w}}{\rm arg\ min} \displaystyle\sum_{s=1}^t \mathbf{g} \cdot \mathbf{w}\end{equation}
