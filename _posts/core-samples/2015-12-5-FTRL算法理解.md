...
\begin{equation}(\displaystyle\sum_{s=1}^t \mathbf{g}_s \cdot \mathbf{w} + \frac 12 \displaystyle\sum_{s=1}^t \sigma_s\|\|\mathbf{w} - \mathbf{w}_s\|\|_2^2)\end{equation}

\begin{equation}(\displaystyle\sum_{s=1}^t \mathbf{g}_s \cdot \mathbf{w} + \frac 12 \displaystyle\sum_{s=1}^t \sigma_s\|\|\mathbf{w} - \mathbf{w}_s\|\|_2^2 + \lambda_1\|\|\mathbf{w}\|\|_1)\end{equation}
